...
export default function Table( { loading, data, title, description, columns, handleAdd, handleEdit, handleDelete }: PropsTable) {
                                                ...
                                                <tr key={index} className="even:bg-gray-50 divide-x divide-slate-200">
                                                    {columns.map((col) => (
                                                        <td key={col.nameFile} className="px-3 py-4 text-sm text-gray-900">
                                                            {dato[col.nameFile] !== null ? dato[col.nameFile] : "—"}
                                                        </td>
                                                    ))}
